...
export function RequestListPage(props: RequestListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRequests({
        relations: ['user', 'warehouse', 'container'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('warehouse', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('container', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'container',
          header: 'Container',
          accessorKey: 'container',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/containers/view/${record.container?.id}`}>
