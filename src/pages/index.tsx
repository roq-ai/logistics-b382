  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless container management with Logistics - Your trusted partner for optimizing inflow and outflow operations in and around France."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1493217465235-252dd9c0d632?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb250YWluZXJzJTJDRnJhbmNlfGVufDB8fHx8MTY4OTgzMTE3OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@iurte?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Iker Urteaga`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless container management with Logistics - Your trusted partner for optimizing inflow and outflow operations in and around France.`}
            </Text>
            <Box
